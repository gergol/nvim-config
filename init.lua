...
local config = {
  ...
  mappings = {
    ...
    n = {
      ...
      ["<C-q>"] = { function() require("user.helpers").toggle_qf() end,
        desc = "Toggle quick fix window" },
      ["<C-k>"] = { ":cprev<cr>", desc = "Prev QF item" },
      ["<C-j>"] = { ":cnext<cr>", desc = "Next QF item" },
      -- Debugger 
	  ["<F9>"] = { function() require("dap").toggle_breakpoint() end, silent = true, desc = "toggle breakpoint" },
	  ["<F10>"] = { function() require("dap").step_over() end, silent = true, desc = "Step over" },
	  ["<F5>"] = { function() require("dap").continue() end, silent = true, desc = "Continue" },
	  ["<S-F11>"] = { function() require("dap").step_out() end, silent = true, desc = "Step out" },
	  ["<F11>"] = { function() require("dap").step_into() end, silent = true, desc = "Step into" },
	  ["<C-K>"] = { function() require("dap.ui.widgets").hover() end, silent = true, desc = "Hover" },
	   -- alternative bindings  
	  ["<leader>dB"] = { function() require("dap").toggle_breakpoint() end, silent = true, desc = "toggle breakpoint" },
	  ["<leader>d;"] = { function() require("dap").step_over() end, silent = true, desc = "Step over" },
	  ["<leader>dc"] = { function() require("dap").continue() end, silent = true, desc = "Continue" },
	  ["<leader>dk"] = { function() require("dap").step_out() end, silent = true, desc = "Step out" },
	  ["<leader>dj"] = { function() require("dap").step_into() end, silent = true, desc = "Step into" },
	  ["<leader>dh"] = { function() require("dap.ui.widgets").hover() end, silent = true, desc = "Hover" },
	  -- Cmake4Vim
